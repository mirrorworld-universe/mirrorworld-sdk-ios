...
public protocol MirrorWordSDKProtocol:NSObjectProtocol {
...
extension MirrorWordSDKProtocol{
    func loginListener(_ userInfo:[String:Any]?,_ onSuccess:Bool,_ onFail:Bool){}
    func userInfo(_ userInfo:[String:Any]?){}
    func getToken(_ userInfo:[String:Any]?){}
    func loginOut(_ success:Bool?){}
...
public class MirrorWordHandleProtocol:NSObject{
        ...
        if keys?.count ?? 0 > 0 {
            keys?.forEach({ key in
                ...
                if key == "data"{
                    ...
                    MirrorWordSDKAuthData.share.userInfo = userInfoObject
                    let schemeInfo = MirrorWordSchemeInfo.userinfo(userInfoObject)
                    schemeInfo.saveInfo()
                ...
                if key == "access_token"{
                    ...
                    MirrorWordSDKAuthData.share.access_token = accToken
                ...
                if key == "refresh_token"{
                    ...
                    MirrorWordSDKAuthData.share.refresh_token = refreToken

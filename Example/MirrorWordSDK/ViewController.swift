...
class ViewController: UIViewController,MirrorWordSDKProtocol {
...
//    ]
    var dataSource = [(moudleTitle:"Auth",MethodList:["Start Login","Logs out a user","CheckAuthenticated"]),
                      (moudleTitle:"Wallet",MethodList:["Waiting for development","Waiting for development"]),
                      (moudleTitle:"Marketplace",MethodList:["OpenWallet"]),
    ]

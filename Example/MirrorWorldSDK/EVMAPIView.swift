    ...
    func onAPISelected(_ view:UIView, paramtersView:inputParamsView,loadingActive: UIActivityIndicatorView!, dataSource:[(moudleTitle: String, MethodList: [String])], tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        ...
        case "getWalletTransactions":
            ...
            paramtersView.paramtersJson = {[weak self] datas in
                ...
                MWSDK.EVM.Wallet.getWalletTransactions(limit: Int(limit)) { response in
                    self?.Log(response)
                    loadingActive.stopAnimating()
                } onFailed: {
        ...
        case "getWalletTransactionBySignature":
            ...
            paramtersView.paramtersJson = {[weak self] datas in
                ...
                MWSDK.EVM.Wallet.getWalletTransactionBySignature(signature: signature) { response in
                    self?.Log(response)
                    loadingActive.stopAnimating()
                } onFailed: {
                    loadingActive.stopAnimating()
        ...
        case "getWalletTokens":
            MWSDK.EVM.Wallet.getWalletTokens { response in
        ...
        case "getWalletTokensByWallet":
            ...
            paramtersView.paramtersJson = {[weak self] datas in
                ...
                MWSDK.EVM.Wallet.getWalletTokensByWallet(wallet_address: to_wallet_address) { response in
                    self?.Log(response)
                    loadingActive.stopAnimating()
                } onFailed: {
                    self?.Log("\(item):failed~")
        ...
        case "getWalletTransactionByWallet":
            view.addSubview(paramtersView)
            ...
            paramtersView.paramtersJson = {[weak self] datas in
                ...
                MWSDK.EVM.Wallet.getWalletTransactionByWallet(wallet_address: to_wallet_address, limit: limit) { response in
                    self?.Log(response)
                    loadingActive.stopAnimating()
                } onFailed: {
                    self?.Log("\(item):failed~")
        ...
        case "getCollectionsInfo":
            ...
            paramtersView.paramtersJson = {[weak self] datas in
                ...
                MWSDK.EVM.Metadata.getCollectionsInfo(collections: [collection_mint]) {[weak self] data in
                    self?.Log(data)
                    loadingActive.stopAnimating()
        ...
        case "getCollectionFilterInfo":
            ...
            paramtersView.paramtersJson = {[weak self] datas in
                ...
                MWSDK.EVM.Metadata.getCollectionFilterInfo(collection: collection) {[weak self] data in
                    self?.Log(data)
                    loadingActive.stopAnimating()
                } onFailed: {[weak self] code, message in
                    loadingActive.stopAnimating()
        ...
        case "getCollectionsSummary":
            ...
            paramtersView.paramtersJson = {[weak self] datas in
                let collection = (datas.first(where: {$0.keyText == "collection_mint"})?.valueText)! as! String
                MWSDK.EVM.Metadata.getCollectionsSummary(collections: [collection]) {[weak self] data in
                    self?.Log(data)
                    loadingActive.stopAnimating()
                } onFailed: {[weak self] code, message in
                    loadingActive.stopAnimating()
        ...
        case "getNFTInfo":
            ...
            paramtersView.paramtersJson = {[weak self] datas in
                ...
                let token_id:Int = (datas.first(where: {$0.keyText == "token_id"})?.valueText)! as! Int
                MWSDK.EVM.Metadata.getNFTInfo(contract: contract,token_id:token_id) {[weak self] data in
                    self?.Log(data)
                    loadingActive.stopAnimating()
                } onFailed: {[weak self] code, message in
                    loadingActive.stopAnimating()
